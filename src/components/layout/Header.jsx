      ...
      <header className="fixed top-0 left-0 right-0 z-40 bg-white/90 backdrop-blur-md border-b border-gray-100 h-14 transition-all duration-300">
        <div className="max-w-md mx-auto px-4 h-full flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-1.5 flex-shrink-0">
            ...
            {/* 🌟 BOTÓN DE COMPARTIR PERFIL INYECTADO */}
            {storeData?.id && (
              <button 
                onClick={async () => {
                  const shareData = {
                  ...
                  try {
                    if (navigator.share) {
                      ...
                      // Fallback si están en un navegador de PC viejo que no soporta compartir nativo
                ...
                className="p-2.5 rounded-full hover:bg-pink-50 hover:text-pink-500 transition-colors active:scale-90 text-gray-800 relative group"
